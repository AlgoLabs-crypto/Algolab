...
inline int GetHashSelection(const uint256 PrevBlockHash, int index) {
    ...
    #define START_OF_LAST_16_NIBBLES_OF_HASH 58
...
//     sph_cubehash512 (&ctx_cubehash, static_cast<const void*>(&hash[3]), 64);
//     sph_cubehash512_close(&ctx_cubehash, static_cast<void*>(&hash[4]));

//     sph_tiger_init(&ctx_tiger);
//     sph_tiger(&ctx_tiger, static_cast<const void*>(&hash[4]), 64);
...
/* DO NOT USE OLD PROTORYPE CODE!!!----------- X3R ------------------------------------------------ */
// template<typename T1>
